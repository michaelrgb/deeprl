...
def make_acrl():
    ...
    def make_networks():
        #shared = make_shared()
        with tf.variable_scope('policy'): policy = _policy(make_shared())
        with tf.variable_scope('value'): value = _value(make_shared())
    ...
    #cost = gradient_override(new.policy.log_prob, adv)
